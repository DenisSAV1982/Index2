...
Изменения 555 в ветке test для отправки в (удалить этот текст при слиянии)


## Создание и синхронизация веток с GitHub

Для того что-бы новая ветка появилась на GitHub нужно ее создать локально, затем сохронить,добавить,закомитить и вввести команду  
```
git push
```
после этого скопировать предлогаемые команды в терминале
```
git push --set-upstream origin <имя ветки>
```
Все последующие сохраненные изменения в этой ветке заливать на github можно  командой 
```
git push
```
